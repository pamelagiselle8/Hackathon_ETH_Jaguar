...
function MisPosts() {
  ...
  const { getPostsByAuthor, posts: allPosts, isLoadingPosts, userAddress } = useContract();
    ...
    <Container size="xl">
      <Stack gap="lg">
        ...
        <Text align="left" c="dimmed" size="sm">
          Aquí puedes ver todas las publicaciones que has creado en el
          blockchain.
        </Text>

        {/* 6. Reemplazar la lista de posts con los datos reales */}
        <div>
          {userPosts.length === 0 ? (
